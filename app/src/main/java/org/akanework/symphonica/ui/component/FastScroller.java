...
import static org.akanework.symphonica.logic.util.FastScrollUtilsKt.isRtl;
import static org.akanework.symphonica.logic.util.FastScrollUtilsKt.toPixels;
import static org.akanework.symphonica.logic.util.FastScrollUtilsKt.toScreenPixels;
...
import org.akanework.symphonica.logic.interfaces.OnFastScrollStateChangeListener;
...
public class FastScroller {
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs) {
        ...
        mThumbHeight = toPixels(resources, 52);
        mThumbWidth = toPixels(resources, 8);
        mTrackWidth = toPixels(resources, 6);

        mTouchInset = toPixels(resources, -24);
        ...
        try {
            ...
            int popupTextSize = typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollPopupTextSize, toScreenPixels(resources, 32));
            int popupBackgroundSize = typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollPopupBackgroundSize, toPixels(resources, 62));
        ...
        mHideRunnable = new Runnable() {
            ...
            public void run() {
                if (!mIsDragging) {
                    ...
                    mAutoHideAnimator = ObjectAnimator.ofInt(FastScroller.this, "offsetX", (isRtl(mRecyclerView.getResources()) ? -1 : 1) * getWidth());
